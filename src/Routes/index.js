...
import { Home, ListBookingPending, Login, MentorListPage, MentorProfile, PageNotFound, Schedule, StudentProfile, Wallet } from "../Pages"
...
const privateRoutes = [
  ...
  { path: '/pending-booking', element: ListBookingPending }
]
