                ...
                <div className="content">
                    <Row align='center' className="top-information">
                        ...
                        <Col flex={8} className='student-information'>
                            ...
                            <Button className='become-mentor-btn custom-btn' type="primary" style={{ marginTop: '1.8rem', marginLeft: '2rem' }}>
                                <Icon icon="ep:avatar" style={{ width: '1.8rem', height: '1.8rem' }} /> Become Mentor
                            </Button>
                        </Col>
                    </Row>
